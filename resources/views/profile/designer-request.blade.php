    ...
    <div class="row mt-3">
        <div class="col-lg">
              <div class="box">
                ...
                <hr>
                <form action="{{ route('designer-role-request-send', Auth::id()) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  
                 <div class="row">
                  <div class="form-group">
                  <label for="description">Give Information about your designing skills and technique.</label>
