...
<div class="col-lg-9">
    ...
    <div class="row mt-3">
        <div class="col-lg">
              <div class="box">
                <h3>Fill this form to become whole sale buyer.</h3>
                <hr>
                <form action="{{ route('wholesalebuyer-role-request-send', Auth::id()) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  
                 <div class="row">
                  <div class="form-group">
                  <label for="description">Give Information about your business</label>
