        ...
        <div class="col-lg">
            <div class="jumbotron">
                ...
                <div class="form-group">
                    ...
                    <textarea name="address1" id="address1" cols="30" rows="10" class="form-control">{{@$address->address_1}}</textarea>
                </div>
                <div class="form-group">
                    <label for="address2">Address 2nd</label>
                    <textarea name="address2" id="address2" cols="30" rows="10" class="form-control">{{@$address->address_2}}</textarea>
                </div>
                <div class="form-group">
                    ...
                    <select name="state" id="state" class="form-control">
                        <option default>Select State</option>
                         @foreach($states as $state) 
                            ...
                            <option value="{{$country->id}}" @if(@$address->state_id == @$state->id) {{'selected'}} @endif>{{$state->name}}</option>
                    ...
                    <select name="city" id="city" class="form-control">
                        <option default>Select City</option>
                         @foreach($cities as $city) 
                            ...
                            <option value="{{$country->id}}" @if(@$address->city_id == @$city->id) {{'selected'}} @endif>{{$city->name}}</option>
